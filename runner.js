...
const DEFAULT_KEYWORDS = [
  ...
  'מסכים לעסקים', 'מסך לעסק', 'מסך מקצועי לעסק', 'מסכים מקצועיים לעסקים',
  'מסכי תצוגה לעסקים', 'מסכי תצוגה דיגיטליים', 'מסכים חכמים לעסקים', 'מסכי 24/7',
  // ── שילוט ──
  'שילוט דיגיטלי', 'שלטי לד לעסקים', 'שלט לד דיגיטלי', 'שילוט דיגיטלי לעסק',
  'שלטים דיגיטליים לעסקים', 'שלטי חוצות דיגיטליים',
  // ── LED סוגים ──
  'מסכי LED חיצוניים', 'מסכי LED גמישים', 'מסכי LED שקופים',
  'קיר וידאו', 'רצפת LED וידאו',
  // ── לפי ענף ──
  'מסכי LED לחנויות', 'שילוט דיגיטלי למסעדות', 'מסכי LED לובי',
  'מסכי LED לחברות ומשרדים', 'מסכים לחדר ישיבות',
  'מסכי LED לאולמות אירועים', 'מסכי LED לגני אירועים',
  'מסכי LED לקניונים', 'מסכי LED לאצטדיונים',
  'מסכי LED לתיאטרון', 'מסכי LED לבתים פרטיים',
  'מסכי שילוט לחלונות ראווה', 'מסכי לד לחניון',
  'שלטי לד לבית כנסת', 'מסכי לד לתחנות דלק',
  'שילוט דיגיטלי לחדרי כושר', 'מסכי LED מלונות',
  'מסכי LED לבריכה', 'מסכי LED ספורט', 'מסכי LED אירועים',
  'מסכי LED לתערוכות', 'שילוט דיגיטלי לבנקים',
  // ── שירותים ──
  'CMS למסכי LED', 'ניהול תוכן מסכים', 'תחזוקת מסכי LED',
  'השכרת מסכי LED לאירועים', 'ניהול תורים דיגיטלי', 'עמדת מידע דיגיטלית',
  'שילוט דיגיטלי לפרסום חיצוני', 'תפריט דיגיטלי למסעדה',
  'מסכי ענק בהתאמה אישית', 'מסכי LED תל אביב', 'שילוט דיגיטלי רשתות',
];
// backward compat
